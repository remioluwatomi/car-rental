    ...
    return (
        <section id='booking-sec' ref={bookingRef} className='team-grid:relative w-[90%] max-w-[1300px] mx-auto bg-white bg-[url(../assets/booking-bg.png)] my-[80px] px-[1.5rem] py-[40px]'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} ref={formRef} className='booking-grid:grid booking-grid-3:grid-cols-3 booking-grid:grid-cols-2 booking-grid:gap-4'>
                <div>
                    <label htmlFor='car-brand-select'><FaCar className='orange-fill inline-block text-[18px] mr-[15px]'/>Select Your Car Type <span>*</span></label><br />
                ...
                <div>
                    <label htmlFor='pick-up-select'><FaMapMarkerAlt className='orange-fill inline-block text-[18px] mr-[15px]'/> Pick-up <span>*</span></label><br />
                ...
                <div>
                    <label htmlFor='drop-off-select'><FaMapMarkerAlt className='orange-fill inline-block text-[18px] mr-[15px]'/> Drop-of <span>*</span></label><br />
                ...
                <div>
                    <label htmlFor='pick-up-input'><FaCalendar className='orange-fill inline-block text-[20px] mr-[15px]'/> Pick-up <span>*</span></label><br />
                    <input className='booking-reserve-input text-[#ababab]' id='picl-up-input' type='date' {...register("pickUpDate", {required:true})} />
                </div>

                <div>
                    <label htmlFor='drop-off-input'><FaCalendar className='orange-fill inline-block text-[18px] mr-[15px]'/> Drop-of <span>*</span></label><br />
